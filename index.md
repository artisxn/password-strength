...
================
[![Build Status](https://travis-ci.org/codicastudio/PasswordStrengthPackage.png?branch=1.x)](https://travis-ci.org/codicastudio/PasswordStrengthPackage)
[![Total Downloads](https://poser.pugx.org/codicastudio/password-strength/downloads)](https://packagist.org/packages/codicastudio/password-strength)
[![License](https://poser.pugx.org/codicastudio/password-strength/license)](https://packagist.org/packages/codicastudio/password-strength)
...
Just ```composer require codicastudio/password-strength:"~0.10"```.

**For Laravel 5/6 users**

Just ```composer require codicastudio/password-strength:"~1.5"```.

**For Laravel 6/7 users**
> Requires PHP 7.1+

Just ```composer require codicastudio/password-strength:"~2.0"```.
...
return [
    ...
    'providers' => [
        // ...
        \codicastudio\PasswordStrength\PasswordStrengthServiceProvider::class,
    ],
    // ...
];
```
...
- [LICENSE](https://github.com/codicastudio/PasswordStrengthPackage/LICENSE)


## Reporting Issues or Feature Requests

Issues and feature requests are tracked on [GitHub](https://github.com/codicastudio/PasswordStrengthPackage/issues).
